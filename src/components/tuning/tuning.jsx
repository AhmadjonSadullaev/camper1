...
import '../../components/tuning/tuningstyle.css';
import HmenuCom from '../motor/hmenu';
import VmenuCom from '../motor/vmenu';
 ...
 function handleVmenu() {
  ...
  return (
    <>
       ...
       <div>
           <div className="tuninghome">
           <div className='used-con'>
             <p>Home</p>
              <h3 >Our ranges</h3>
              <h1 >Tuning Car</h1>
              </div> 
